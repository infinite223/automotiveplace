...
import { AMPSearch } from "../components/shared/AMPSearch";
import { HomeSearchBar } from "./HomeSearchBar";
import { IoPersonCircle } from "react-icons/io5";

export const HomeHeader = () => {
  return (
    <div className="flex w-full items-center justify-between p-2 border-b-2 border-zinc-100 dark:border-zinc-900 gap-6">
