...
export const HomeSearchBarFilterView: FC<IHomeSearchBarFilterView> = ({
  ...
  return (
    <div className="flex rounded-md items-start w-[300px] sm:w-[640px] lg:w-[1024px] md:w-[768px] xl:w-[1280px] max-h-screen justify-start p-2 pr-3 pl-3 absolute top-[125px] self-center bg-zinc-900 z-30">
